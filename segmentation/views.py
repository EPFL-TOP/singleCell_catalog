...
def build_mva_detection_categories():
    ...
    cellflags_alive     = CellFlag.objects.filter(cell_roi.frame.sample.peaks_tod_div_validated==True, alive=True, dividing=False, double_nuclei=False, elongated=False, flat=False, multiple_cells=False, pair_cell=False, round=False).order_by("?")
