...
def segmentation_handler(doc: bokeh.document.Document) -> None:
   ...
   #current image to be displayed
    ...
    plot_image     = bokeh.plotting.figure(x_range=(0, ind_images_list[0][0].shape[0]), y_range=(0, ind_images_list[0][0].shape[1]), tools="box_select,wheel_zoom,box_zoom,reset,undo",width=750, height=750)
    ...
    plot_nosc      = bokeh.plotting.figure(title="Number of oscillations", x_axis_label='Number of oscillations', y_axis_label='Number of positions',width=750, height=250)
    ...
    def select_tap_callback():
        ...
        Bokeh.documents[0].root.force_render();
    ...
    tap_tool = bokeh.models.TapTool(callback=bokeh.models.CustomJS(args=dict(other_source=index_source, tap_tool=tap_tool),code=select_tap_callback()))
