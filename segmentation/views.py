    ...
    def segment_cell_callback():
        ...
        for frame in frames:
            ...
            for cellROI in cellROIs:
                ...
                #contour=segtools.segmentation_test(source_img_ch.data['img'][0], 2., frame.height-cellROI.min_row, cellROI.min_col, frame.height-cellROI.max_row, cellROI.max_col)
