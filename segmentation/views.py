...
def segmentation_handler(doc: bokeh.document.Document) -> None:
    ...
    plot_osc_tod   = bokeh.plotting.figure(title="Start/End of Oscilation and Time of death", x_axis_label='Time (minutes)', y_axis_label='Number of positions',width=1000, height=500)
    plot_nosc      = bokeh.plotting.figure(title="Number of oscillations", x_axis_label='Number of oscillations', y_axis_label='Number of positions',width=500, height=500)
    ...
    plot_osc_tod.vbar(x='x', top='top', width=0.5, source=source_start_osc, fill_alpha=0.25, fill_color='green', line_color='green')
    ...
    plot_osc_tod.vbar(x='x', top='top', width=0.5, source=source_end_osc, fill_alpha=0.25, fill_color='red', line_color='red')
    ...
    plot_osc_tod.vbar(x='x', top='top', width=0.5, source=source_tod, alpha=0.25, color='black', line_color='black')
