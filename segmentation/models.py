...
class Sample(models.Model):
    ...
    peaks_tod_div_validated         = models.BooleanField(help_text="sample has been checked flag", default=False)
    #peaks_tod_div_validated  = models.BooleanField(help_text="check this sample flag", default=False)
