...
def segmentation_handler(doc: bokeh.document.Document) -> None:
   ...
   #current image to be displayed
    ...
    def fill_rois():
        ...
        exp = Experiment.objects.get(name=dropdown_exp.value)
        samples = Sample.objects.select_related(experiment=exp)
        ...
        for sample in samples:
            ...
            for frame in frames:
                ...
                image_stack_rois_dict[file_name][frame.number]   = {'left':[], 'right':[], 'top':[], 'bottom':[]}
