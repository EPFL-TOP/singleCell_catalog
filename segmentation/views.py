...
def index(request):
    ...
    if selected_position != None:
        ...
        for roi in rois:
            p.rect(roi.min_col+(roi.max_col-roi.min_col)/2, 512-(roi.min_row+(roi.max_row-roi.min_row)/2), roi.max_col-roi.min_col, roi.max_col-roi.min_col, line_width=2, fill_alpha=0, line_color="white") 
